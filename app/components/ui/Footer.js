        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/productos/todos" className="text-gray-300 hover:text-gray-400">
                  Productos
                </Link>
              </li>
              <li>
  {/* Icono SVG para Admin */}
  <Link href="/admin" className="text-gray-300 hover:text-gray-400 flex items-center">
    ...
    Admin
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              <li><a href="https://github.com/franciscopassarelli" className="text-gray-300 hover:text-gray-400">Github</a></li>
            
              <li><a href="https://www.linkedin.com/in/franciscopassarelli/" className="text-gray-300 hover:text-gray-400">LinkedIn</a></li>
            </ul>
          </div>
          <div className="col-span-1">
